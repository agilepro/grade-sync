...
class grade_export_sl extends grade_export {
    ...
    public function grade_export_sl($course, $groupid=0, $itemlist='', $export_feedback=false, $updatedgradesonly = false, $displaytype = GRADE_DISPLAY_TYPE_REAL, $decimalpoints = 2, $separator='comma') {
    ...
    public function print_grades() {
        ...
        $xml = simplexml_load_file("SampleRoster.xml");
        $root = $xml['root'];
        $roster = $xml->roster;
